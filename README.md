...
## Overview
  This repository serves as the document for my 3 years long rigor self-study program designed to fill the gap between high school curicculum and advanced theoretical physics.
...
**Objective:** To Build the Mathematical foundation required to understand Quantum Field Theory 

## Curicculum Roadmap
The study was conducted in two distinct phases: **Mathematic** and **Quantum Mechanics**

| Phase | Subject | Source Material | Key Output |
| :--- | :--- | :--- | :--- |
| **I** | **Rigorous Foundations** | *Calculus Vol. 1* (Apostol) | Derivation of Limits & Integrals |
